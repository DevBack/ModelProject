...
## 2.2 Velocity
O velocity desta sprint foi de **25,5 pontos**. Todos os pontos planejados e débitos foram entregues nessa sprint. A tabela utilizada par ao cálculo do velocity e o gráfico podem ser vistos abaixo.
